  ...
  return (
    <div>
      <div className="body-cadastro">
        ...
        <p className='paragrafo2'><FiCheckCircle style={{ marginRight: '10px' }} />Faça seu <b>cadastro</b> para aproveitar todos os <b>benefícios exclusivos</b> que nossa plataforma oferece. </p>
        <div className="box-campos">
          <p className='p'>*Todos os campos devem ser preenchidos.</p>
          <div>
            <label>Nome completo*</label>
            <input type="text" placeholder="Seu nome completo" value={nome} onChange={(e) => setNome(e.target.value)} required /> <br />
            {errors.nome && <span style={{ color: 'red' }}>{errors.nome}</span>}
          </div>
          <div>
            <label>E-mail*</label>
            <input type='email' placeholder="Digite seu e-mail" value={email} onChange={(e) => setEmail(e.target.value)} /> <br />
          ...
          <section>
            <div>
              <label>CPF*</label>
              <InputMask mask="999.999.999-99" value={cpf} onChange={(e) => setCpf(e.target.value)} placeholder="Digite seu CPF" />
